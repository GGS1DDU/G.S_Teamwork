...
//				UserVO vo=new UserVO(IDtext.getText(),passwordtext.getText(),nametext.getText(),comboBox.getName());
				UserBL userbl=new UserBL();
				boolean addsucceed=false;
				try {
						addsucceed = userbl.addUser(IDtext.getText(), passwordtext.getText(), nametext.getText(), job.getSelectedItem().toString());				
					}
				catch (Exception e) {
				}
				if(addsucceed==true){

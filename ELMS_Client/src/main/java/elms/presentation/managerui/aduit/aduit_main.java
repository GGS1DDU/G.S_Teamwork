...
public class aduit_main extends JPanel{
	...
	public aduit_main() throws IOException{	
		...
		add(jcb); jcb.setBounds((int)(3*w/4+40), (int) (2*h/3-70), 120, 25);
		...
		JPanel jp=new JPanel();jp.setLayout(null);jp.setVisible(true);
		jp.setOpaque(false);
		add(jp);jp.setBounds(0,(int) (2*h/3),(int)w,60);

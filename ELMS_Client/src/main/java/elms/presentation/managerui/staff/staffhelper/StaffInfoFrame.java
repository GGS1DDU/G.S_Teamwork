...
public class StaffInfoFrame extends JFrame{
	...
	public StaffInfoFrame() {
		...
		tag2 = new TagPanel("职务信息");
		tag2.setBounds(10, personInfo.getHeight() + tag1.getHeight(), 80, 30);
		add(tag2);
	...
	private void addPersonInfo() {
		...
		personInfo.setBounds(0, 30, this.getWidth(), this.getHeight() / 2 - 20);
	...
	private void addJobInfo() {
		...
		jobInfo.setBounds(0, personInfo.getHeight() + tag1.getHeight() * 2,
				this.getWidth(), 150);
		add(jobInfo);
	...
	protected Dimension getButtonPanelLocation(){
		Dimension d = new Dimension(0, personInfo.getHeight() + jobInfo.getHeight()
				+ tag1.getHeight() + tag2.getHeight());
		return d;
	}
